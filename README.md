...
El objetivo es presentar información profesional, habilidades técnicas y proyectos destacados en una interfaz moderna, clara y completamente responsiva.
...
Uso de imágenes adaptativas con <picture>
Tarjetas de proyectos con proporción consistente (16:9)
Organización modular del CSS por secciones (header, main, footer)
...
960px (Cambio de imagen adaptativa)
768px (Tablet)
600px (Cambio de layout estructural)
480px (Refinamiento mobile)
320px (Mobile mínimo)
